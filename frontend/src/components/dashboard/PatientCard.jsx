...
export default function PatientCard({ patient }) {
  ...
  return (
    <div 
      ...
      className="bg-slate-800/40 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-5 cursor-pointer hover:bg-slate-800/80 hover:-translate-y-1 hover:shadow-lg hover:shadow-slate-900/20 transition-all group"
    >
